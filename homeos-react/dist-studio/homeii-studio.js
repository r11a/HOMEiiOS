...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	var he = me(null), k = me(null), ge = me(null), _e = me(null);
	function ve(e, t) {
		switch (O(ge, t), O(k, e), O(he, null), t.nodeType) {
			case 9:
			case 11:
	...
	function xe(e) {
		k.current === e && (D(he), D(k)), _e.current === e && (D(_e), Qf._currentValue = de);
	}
	var Se, Ce;
	function we(e) {
		if (Se === void 0) try {
	...
	function Hc(e, t, n) {
		...
		switch (Bi(t), t.tag) {
			...
			case 19:
				...
				return r.tail === null ? (B(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Pe(), e.sibling = null, n = N.current, O(N, a ? n & 1 | 2 : n & 1), j && Li(t, r.treeForkCount), e);
			case 22:
...
function w({ hass: e, widget: t, meta: n, entities: r, pickerValue: i, setPickerValue: a, updateWidget: o, duplicateWidget: s, removeWidget: c }) {
...
function ie({ hass: e } = {}) {
	let [t, n] = (0, b.useState)(), [r, i] = (0, b.useState)(), [a, o] = (0, b.useState)(), [s, c] = (0, b.useState)(""), [l, u] = (0, b.useState)("טוען את HOMEii…"), [d, f] = (0, b.useState)(!1), [p, m] = (0, b.useState)(""), [h, g] = (0, b.useState)([]), [_, v] = (0, b.useState)([]), [y, re] = (0, b.useState)(""), [ie, ae] = (0, b.useState)("");
	...
	async function se() {
		...
		try {
			let [e, t] = await Promise.all([oe("active"), oe("discovery")]);
	...
	function pe(e) {
		if (!a || !k) return;
		let t = C[e], n = r?.areas.find((e) => e.area_id === k.areaId), i = (n?.entities ?? []).filter((n) => t.domains.includes(n.domain) && n.assignment_source === "entity" && (e !== "sensor.temperature" || n.device_class === "temperature")), o = `${k.areaId}-${e.replaceAll(".", "-")}-${Date.now()}`, s = n?.entities.find((e) => e.available !== !1)?.entity_id ?? "", c = {
			id: o,
			widgetType: e,
	...
	let k = a?.areas[s], ge = k?.widgets.find((e) => e.id === p), _e = r?.areas.find((e) => e.area_id === s), ve = ge ? C[ge.widgetType] : void 0, ye = (e, t, n) => n === "custom" ? t ?? e : r?.areas.find((t) => t.area_id === e)?.name ?? t ?? e, be = (0, b.useMemo)(() => Object.values(a?.areas ?? {}).reduce((e, t) => e + t.widgets.reduce((e, t) => e + t.entityIds.length, 0), 0), [a]);
		...
		children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [
					...
					Object.values(a.areas).map((e) => /* @__PURE__ */ (0, x.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, x.jsx)("span", { children: ye(e.areaId, e.title, e.titleMode) }), /* @__PURE__ */ (0, x.jsxs)("small", { children: [e.widgets.length, " Widgets נבחרו"] })]
					}, e.areaId)),
			...
			/* @__PURE__ */ (0, x.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("div", {
					...
					style: k?.picture ? { backgroundImage: `linear-gradient(90deg,#111d,#1113),url(${k.picture})` } : void 0,
					children: [
						/* @__PURE__ */ (0, x.jsxs)("small", { children: [a.brand.name, " · LIVE PREVIEW"] }),
						/* @__PURE__ */ (0, x.jsx)("h1", { children: k ? ye(k.areaId, k.title, k.titleMode) : "" }),
						/* @__PURE__ */ (0, x.jsx)("p", { children: a.brand.tagline }),
						/* @__PURE__ */ (0, x.jsx)("div", {
							className: "studio-categories",
							children: (k?.categories ?? []).map((e) => /* @__PURE__ */ (0, x.jsx)("span", { children: te[e] ?? e }, e))
						})
					]
				}), /* @__PURE__ */ (0, x.jsx)("div", {
					className: "studio-widgets",
					children: k?.widgets.map((e) => /* @__PURE__ */ (0, x.jsxs)("article", {
						draggable: !0,
						className: p === e.id ? "selected" : "",
						onClick: () => m(e.id),
						onDragStart: (t) => t.dataTransfer.setData("text/homeii-widget", e.id),
						onDragOver: (e) => e.preventDefault(),
						onDrop: (t) => D(t.dataTransfer.getData("text/homeii-widget"), e.id),
						children: [
							/* @__PURE__ */ (0, x.jsx)("div", {
			...
			ge && /* @__PURE__ */ (0, x.jsx)(w, {
				hass: e,
				widget: ge,
				meta: ve,
				entities: _e?.entities ?? [],
				pickerValue: ie,
				setPickerValue: ae,
				updateWidget: me,
				duplicateWidget: O,
				removeWidget: () => {
					k && (E(k.areaId, (e) => ({
						...e,
						excludedWidgetIds: ge.settings?.generated ? [.../* @__PURE__ */ new Set([...e.excludedWidgetIds ?? [], ge.id])] : e.excludedWidgetIds,
						widgets: e.widgets.filter((e) => e.id !== ge.id)
					})), m(""));
				}
			}),
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsxs)("section", { children: [
						...
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							...
							/* @__PURE__ */ (0, x.jsx)("input", {
								...
								onChange: (e) => de("radius", Number(e.target.value))
							})
						] }),
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							"טשטוש זכוכית · ",
							...
							/* @__PURE__ */ (0, x.jsx)("input", {
								...
								onChange: (e) => de("blur", Number(e.target.value))
							})
						] }),
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							"שקיפות אריחים · ",
							...
							/* @__PURE__ */ (0, x.jsx)("input", {
								...
								onChange: (e) => de("tileOpacity", Number(e.target.value) / 100)
							})
						] })
					] }),
					k && /* @__PURE__ */ (0, x.jsxs)("section", { children: [
						/* @__PURE__ */ (0, x.jsx)("small", {
							className: "eyebrow",
						...
						/* @__PURE__ */ (0, x.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, x.jsx)("input", {
								type: "checkbox",
								checked: k.titleMode === "custom",
								onChange: (e) => E(k.areaId, (t) => ({
									...t,
									titleMode: e.target.checked ? "custom" : "auto",
									title: e.target.checked ? ye(t.areaId, t.title) : t.title
								}))
							}), "שם מותאם במקום שם HA"]
						}),
						k.titleMode === "custom" && /* @__PURE__ */ (0, x.jsxs)("label", { children: ["שם מוצג", /* @__PURE__ */ (0, x.jsx)("input", {
							value: k.title ?? "",
							onChange: (e) => E(k.areaId, (t) => ({
								...t,
						...
						/* @__PURE__ */ (0, x.jsx)("div", {
							...
							children: Object.entries(te).map(([e, t]) => /* @__PURE__ */ (0, x.jsx)("button", {
								className: (k.categories ?? []).includes(e) ? "active" : "",
								onClick: () => E(k.areaId, (t) => ({
									...t,
					...
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("b", { children: Object.keys(a.areas).length }), " Areas"] }), /* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("b", { children: be }), " bindings"] })]
					})
				]
			})
		]
