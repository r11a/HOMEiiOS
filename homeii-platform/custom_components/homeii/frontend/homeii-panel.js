...
function te({ widget: e, hass: t, onFeedback: n }) {
	...
	if (e.widgetType === "legacy.lovelace-card" && e.settings?.source && typeof e.settings.source == "object") return /* @__PURE__ */ (0, x.jsx)(S, {
		hass: t,
		config: e.settings.source
	});
	...
	return e.widgetType.startsWith("sensor.") && i ? /* @__PURE__ */ (0, x.jsxs)("article", {
...
customElements.get("homeii-panel") || customElements.define("homeii-panel", se);
//#endregion
