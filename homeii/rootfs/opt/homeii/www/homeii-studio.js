...
function C() {
	...
	async function f() {
		...
		try {
			let [e, n] = await Promise.all([ee("active"), ee("discovery")]);
			t(e), r(n), a(e.project ?? void 0), s((t) => t || Object.keys(e.project?.areas ?? {})[0] || ""), l(e.project ? "מסונכרן · Project פעיל" : "מוכן ליצירת Project ראשון");
		} catch (e) {
			l(`שגיאת חיבור: ${e.message}`);
		}
	}
	(0, b.useEffect)(() => {
		f();
		...
		if (e) {
			...
			try {
				...
				t({
					...e,
					revision: n.revision,
					active_project_id: n.project.id,
					project: n.project
				}), a(n.project), s(Object.keys(n.project.areas)[0] || ""), l("Project נוצר ופורסם");
			} catch (e) {
				l(`היצירה נכשלה: ${e.message}`);
			} finally {
				d(!1);
			}
		}
		...
		if (!(!i || !e)) {
			...
			try {
				...
				t({
					...
					revision: n.revision,
					project: i
				}), l("השינויים פורסמו לכל המכשירים");
			} catch (e) {
				l(`השמירה נכשלה: ${e.message}`);
			} finally {
				d(!1);
			}
		}
	}
	let g = i?.areas[o], _ = (0, b.useMemo)(() => Object.values(i?.areas ?? {}).reduce((e, t) => e + t.widgets.reduce((e, t) => e + t.entityIds.length, 0), 0), [i]);
		...
		children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, x.jsx)("h2", { children: "Areas" }), Object.values(i.areas).map((e) => /* @__PURE__ */ (0, x.jsxs)("button", {
					...
					onClick: () => s(e.areaId),
					children: [/* @__PURE__ */ (0, x.jsx)("span", { children: e.title }), /* @__PURE__ */ (0, x.jsxs)("small", { children: [e.widgets.length, " Widgets"] })]
				}, e.areaId))]
			}),
			/* @__PURE__ */ (0, x.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, x.jsx)("h1", { children: g?.title }),
					...
					children: g?.widgets.map((e) => /* @__PURE__ */ (0, x.jsxs)("article", { children: [
						...
						/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: S[e.widgetType] ?? e.widgetType }), /* @__PURE__ */ (0, x.jsxs)("small", { children: [
							e.entityIds.length,
							" ישויות · ",
							e.size
						] })] }),
			...
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("b", { children: Object.keys(i.areas).length }), " Areas"] }), /* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("b", { children: _ }), " bindings"] })]
					})
				]
			})
		]
