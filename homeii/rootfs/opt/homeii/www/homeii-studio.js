...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function Ic(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return vc(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : j || (n = t.type, e = t.pendingProps, r = Bd(ve.current).createElement(n), r[gt] = t, r[_t] = e, Pd(r, n, e), k(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
	...
	function Hc(e, t, n) {
		...
		switch (Bi(t), t.tag) {
			...
			case 19:
				...
				return r.tail === null ? (B(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Fe(), e.sibling = null, n = N.current, D(N, a ? n & 1 | 2 : n & 1), j && Li(t, r.treeForkCount), e);
			case 22:
	...
	function pu() {
		return W & 2 && q !== 0 ? q & -q : w.T === null ? pt() : dd();
	}
	function mu() {
		if (Yl === 0) {
			if (!(q & 536870912) || j) {
...
function re({ hass: e, value: t, domains: n, entities: r, onChange: i }) {
...
function ie({ hass: e, widget: t, meta: n, entities: r, pickerValue: i, setPickerValue: a, updateWidget: o, duplicateWidget: s, removeWidget: c }) {
...
function ae({ hass: e, entities: t, type: n, entity: r, setType: i, setEntity: a, onClose: o, onComplete: s }) {
	let c = n ? C[n] : void 0;
		...
		children: /* @__PURE__ */ (0, x.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "QUICK ADD" }), /* @__PURE__ */ (0, x.jsx)("h2", { children: n ? "בחר ישות" : "איזה כרטיס להוסיף?" })] }), /* @__PURE__ */ (0, x.jsx)("button", {
				...
				/* @__PURE__ */ (0, x.jsxs)("label", {
					...
					children: ["ישות", /* @__PURE__ */ (0, x.jsx)(re, {
						hass: e,
						value: r,
						domains: c?.domains ?? [],
				...
				children: Object.entries(C).map(([e, n]) => {
...
function oe({ hass: e } = {}) {
	let [t, n] = (0, b.useState)(), [r, i] = (0, b.useState)(), [a, o] = (0, b.useState)(), [s, c] = (0, b.useState)(""), [l, u] = (0, b.useState)("טוען את HOMEii…"), [d, f] = (0, b.useState)(!1), [p, m] = (0, b.useState)(""), [h, g] = (0, b.useState)([]), [_, v] = (0, b.useState)([]), [y, re] = (0, b.useState)(""), [oe, se] = (0, b.useState)(""), [ce, le] = (0, b.useState)(!1), [ue, de] = (0, b.useState)(""), [w, T] = (0, b.useState)(""), [fe, pe] = (0, b.useState)(!1);
	async function me(t, n) {
		if (!e?.callWS) return ee(t, n);
	...
	async function he() {
		...
		try {
			let [e, t] = await Promise.all([me("active"), me("discovery")]);
	...
	function xe(e, t) {
		if (!a || !O) return;
		let n = C[e], i = r?.areas.find((e) => e.area_id === O.areaId), o = (i?.entities ?? []).filter((t) => n.domains.includes(t.domain) && t.assignment_source === "entity" && (e !== "sensor.temperature" || t.device_class === "temperature")), s = `${O.areaId}-${e.replaceAll(".", "-")}-${Date.now()}`, c = i?.entities.find((e) => e.available !== !1)?.entity_id ?? "", l = t ?? (e === "legacy.lovelace-card" ? c ? [c] : [] : o.slice(0, 12).map((e) => e.entity_id)), u = {
			id: s,
			widgetType: e,
			entityIds: l,
			size: n.size,
	...
	let O = a?.areas[s], De = O?.widgets.find((e) => e.id === p), Oe = r?.areas.find((e) => e.area_id === s), ke = De ? C[De.widgetType] : void 0, Ae = (e, t, n) => n === "custom" ? t ?? e : r?.areas.find((t) => t.area_id === e)?.name ?? t ?? e, je = (0, b.useMemo)(() => Object.values(a?.areas ?? {}).reduce((e, t) => e + t.widgets.reduce((e, t) => e + t.entityIds.length, 0), 0), [a]);
	...
	return /* @__PURE__ */ (0, x.jsxs)("main", {
		className: `studio-shell ${fe ? "show-advanced" : ""}`,
		dir: "rtl",
		style: Me,
		children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [
					...
					Object.values(a.areas).map((e) => /* @__PURE__ */ (0, x.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, x.jsx)("span", { children: Ae(e.areaId, e.title, e.titleMode) }), /* @__PURE__ */ (0, x.jsxs)("small", { children: [e.widgets.length, " Widgets נבחרו"] })]
					}, e.areaId)),
					...
					/* @__PURE__ */ (0, x.jsx)("div", {
						...
						children: Object.entries(C).filter(([, e]) => e.label.includes(y) || !y).map(([e, t]) => /* @__PURE__ */ (0, x.jsxs)("button", {
							onClick: () => xe(e),
							children: [
			...
			/* @__PURE__ */ (0, x.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsx)("button", {
						...
						onClick: () => pe((e) => !e),
						children: fe ? "סגור הגדרות" : "עיצוב והגדרות"
					}),
					/* @__PURE__ */ (0, x.jsxs)("div", {
						className: "studio-hero",
						style: O?.picture ? { backgroundImage: `linear-gradient(90deg,#111d,#1113),url(${O.picture})` } : void 0,
						children: [
							/* @__PURE__ */ (0, x.jsxs)("small", { children: [a.brand.name, " · LIVE PREVIEW"] }),
							/* @__PURE__ */ (0, x.jsx)("h1", { children: O ? Ae(O.areaId, O.title, O.titleMode) : "" }),
							/* @__PURE__ */ (0, x.jsx)("p", { children: a.brand.tagline }),
							/* @__PURE__ */ (0, x.jsx)("div", {
								className: "studio-categories",
								children: (O?.categories ?? []).map((e) => /* @__PURE__ */ (0, x.jsx)("span", { children: te[e] ?? e }, e))
							})
						]
					}),
					/* @__PURE__ */ (0, x.jsx)("div", {
						className: "studio-widgets",
						children: O?.widgets.map((e) => /* @__PURE__ */ (0, x.jsxs)("article", {
							draggable: !0,
							className: p === e.id ? "selected" : "",
							onClick: () => m(e.id),
							onDragStart: (t) => t.dataTransfer.setData("text/homeii-widget", e.id),
							onDragOver: (e) => e.preventDefault(),
							onDrop: (t) => we(t.dataTransfer.getData("text/homeii-widget"), e.id),
							children: [
								/* @__PURE__ */ (0, x.jsx)("div", {
									className: "widget-icon",
									children: C[e.widgetType]?.glyph ?? S[e.widgetType]?.[0] ?? "H"
								}),
								/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: C[e.widgetType]?.label ?? S[e.widgetType] ?? e.widgetType }), /* @__PURE__ */ (0, x.jsxs)("small", { children: [
									e.entityIds.length,
									" ישויות · ",
									e.size
								] })] }),
			...
			ce && /* @__PURE__ */ (0, x.jsx)(ae, {
				hass: e,
				entities: Oe?.entities ?? [],
				type: ue,
				entity: w,
				setType: de,
				setEntity: T,
			...
			De && /* @__PURE__ */ (0, x.jsx)(ie, {
				...
				removeWidget: () => {
					O && (ve(O.areaId, (e) => ({
						...e,
						excludedWidgetIds: De.settings?.generated ? [.../* @__PURE__ */ new Set([...e.excludedWidgetIds ?? [], De.id])] : e.excludedWidgetIds,
						widgets: e.widgets.filter((e) => e.id !== De.id)
					})), m(""));
				}
			}),
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsxs)("section", { children: [
						...
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							...
							/* @__PURE__ */ (0, x.jsx)("input", {
								...
								onChange: (e) => ye("radius", Number(e.target.value))
							})
						] }),
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							"טשטוש זכוכית · ",
							...
							/* @__PURE__ */ (0, x.jsx)("input", {
								...
								onChange: (e) => ye("blur", Number(e.target.value))
							})
						] }),
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							"שקיפות אריחים · ",
							...
							/* @__PURE__ */ (0, x.jsx)("input", {
								...
								onChange: (e) => ye("tileOpacity", Number(e.target.value) / 100)
							})
						] })
					] }),
					O && /* @__PURE__ */ (0, x.jsxs)("section", { children: [
						/* @__PURE__ */ (0, x.jsx)("small", {
							className: "eyebrow",
						...
						/* @__PURE__ */ (0, x.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, x.jsx)("input", {
								type: "checkbox",
								checked: O.titleMode === "custom",
								onChange: (e) => ve(O.areaId, (t) => ({
									...t,
									titleMode: e.target.checked ? "custom" : "auto",
									title: e.target.checked ? Ae(t.areaId, t.title) : t.title
								}))
							}), "שם מותאם במקום שם HA"]
						}),
						O.titleMode === "custom" && /* @__PURE__ */ (0, x.jsxs)("label", { children: ["שם מוצג", /* @__PURE__ */ (0, x.jsx)("input", {
							value: O.title ?? "",
							onChange: (e) => ve(O.areaId, (t) => ({
								...t,
						...
						/* @__PURE__ */ (0, x.jsx)("div", {
							...
							children: Object.entries(te).map(([e, t]) => /* @__PURE__ */ (0, x.jsx)("button", {
								className: (O.categories ?? []).includes(e) ? "active" : "",
								onClick: () => ve(O.areaId, (t) => ({
									...t,
					...
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("b", { children: Object.keys(a.areas).length }), " Areas"] }), /* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("b", { children: je }), " bindings"] })]
					})
				]
			})
		]
