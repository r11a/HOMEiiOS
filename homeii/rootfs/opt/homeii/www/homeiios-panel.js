...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function bi(e, t, n, r, a, o) {
		...
		if (r = e, typeof e == "function") _i(e) && (s = 1);
			...
			case re: return e = gi(31, n, t, a), e.elementType = re, e.lanes = o, e;
	...
	function Ua(e) {
		...
		function l(e, t, n, r) {
			var i = n.type;
			return i === y ? d(e, t, n.props.children, r, n.key) : t !== null && (t.elementType === i || typeof i == "object" && i && i.$$typeof === T && Pa(i) === t.type) ? (t = a(t, n.props), Va(t, n), t.return = e, t) : (t = bi(n.type, n.key, n.props, null, e.mode, r), Va(t, n), t.return = e, t);
		}
		function u(e, t, n, r) {
		...
		function p(e, t, n, r) {
			...
			if (typeof n == "object" && n) {
				switch (n.$$typeof) {
					...
					case T: return n = Pa(n), p(e, t, n, r);
				}
		...
		function m(e, t, n, r, i) {
			...
			if (typeof r == "object" && r) {
				switch (r.$$typeof) {
					...
					case T: return r = Pa(r), m(e, t, n, r, i);
				}
			...
			if (typeof o == "object" && o && o.type === y && o.key === null && (o = o.props.children), typeof o == "object" && o) {
				switch (o.$$typeof) {
						...
						a: {
							for (var l = o.key; r !== null;) {
								if (r.key === l) {
									...
									} else if (r.elementType === l || typeof l == "object" && l && l.$$typeof === T && Pa(l) === r.type) {
					...
					case v:
						...
						return s(e);
					case T: return o = Pa(o), b(e, r, o, c);
				}
				...
				if (o.$$typeof === C) return b(e, r, la(e, o), c);
				Ha(e, o);
			}
	...
	function Ro(e) {
		...
		if (t ??= {
			data: [],
			index: 0
		}, n === null && (n = Fo(), F.updateQueue = n), n.memoCache = t, n = t.data[t.index], n === void 0) for (n = t.data[t.index] = Array(e), r = 0; r < e; r++) n[r] = ie;
		return t.index++, n;
	}
	function zo(e, t) {
		...
		switch (zi(t), t.tag) {
			...
			case 27:
				if (be(t), n = he.current, a = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Ic(t);
					...
					e = me.current, Ji(t) ? Ki(t, e) : (e = ff(a, r, n), t.stateNode = e, Ic(t));
				}
				return V(t), null;
			case 5:
			...
			case 19:
				...
				return r.tail === null ? (V(t), null) : (e = r.tail, r.rendering = e, r.tail = e.sibling, r.renderingStartTime = Ne(), e.sibling = null, n = P.current, k(P, a ? n & 1 | 2 : n & 1), M && Ii(t, r.treeForkCount), e);
			case 22:
	...
	function pu() {
		return W & 2 && q !== 0 ? q & -q : E.T === null ? dt() : dd();
	}
	function mu() {
		if (Yl === 0) {
			if (!(q & 536870912) || M) {
...
function S({ hass: e, config: t }) {
	let n = (0, b.useRef)(null), [r, i] = (0, b.useState)("");
	return (0, b.useEffect)(() => {
		let r, a = !1;
		async function o() {
			try {
				if (!window.loadCardHelpers) throw Error("HA card helpers are unavailable");
				let i = await window.loadCardHelpers();
				if (a || !n.current) return;
				r = i.createCardElement(t), r.hass = e, n.current.replaceChildren(r);
			} catch (e) {
				a || i(e instanceof Error ? e.message : String(e));
			}
		}
		return o(), () => {
			a = !0, r?.remove();
		...
		t && (t.hass = e);
	}, [e]), /* @__PURE__ */ (0, x.jsx)("article", {
		className: "runtime-widget ha-card-widget",
		children: r ? /* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: "כרטיס HA לא נטען" }), /* @__PURE__ */ (0, x.jsx)("small", { children: r })] }) : /* @__PURE__ */ (0, x.jsx)("div", { ref: n })
	});
}
//#endregion
//#region src/runtime/RuntimeWidget.tsx
var C = {
	"light.collection": "תאורה",
	"climate.thermostat": "אקלים",
	"media.player": "מדיה",
	"camera.viewer": "מצלמה",
	"cover.control": "פתחים",
	"fan.control": "מאוורר",
	...
	"security.lock": "מנעול",
	"security.alarm": "אזעקה",
	"sensor.temperature": "טמפרטורה",
	"sensor.humidity": "לחות",
	"sensor.power": "הספק",
	"sensor.energy": "אנרגיה",
	"sensor.value": "חיישן",
	"binary_sensor.status": "מצב",
	"person.presence": "נוכחות",
	"weather.forecast": "מזג אוויר",
	"entity.generic": "ישויות"
}, w = (e) => String(e?.attributes.friendly_name ?? e?.entity_id.split(".")[1]?.replaceAll("_", " ") ?? "ישות"), ee = /* @__PURE__ */ new Set([
	"off",
	"unavailable",
	"unknown",
	"idle",
...
function te({ widget: e, hass: t, onFeedback: n }) {
	let r = (0, b.useMemo)(() => e.entityIds.map((e) => t.states[e]).filter(Boolean), [e.entityIds, t.states]), i = r[0], a = r.filter((e) => !ee.has(e.state)).length;
	async function o(e) {
		await t.callService("homeassistant", "toggle", {}, { entity_id: e.entity_id }), n(`${w(e)} · הפעולה נשלחה`);
	}
	async function s(e) {
		if (!i) return;
		let r = Number(i.attributes.temperature ?? i.attributes.target_temp_high ?? 24);
		await t.callService("climate", "set_temperature", { temperature: r + e }, { entity_id: i.entity_id }), n(`טמפרטורת היעד ${r + e}°`);
	}
	if (e.widgetType === "legacy.lovelace-card" && e.settings?.source && typeof e.settings.source == "object") {
		let n = e.settings.source, r = n.type === "entities" ? {
			...n,
			entity: void 0,
			entities: e.entityIds
		} : {
			...n,
			entities: void 0,
			entity: e.entityIds[0] ?? n.entity
		};
	...
	if (e.widgetType === "climate.thermostat" && i) {
		let t = Number(i.attributes.current_temperature ?? 0), n = Number(i.attributes.temperature ?? i.attributes.target_temp_high ?? 0), r = i.state;
		return /* @__PURE__ */ (0, x.jsxs)("article", {
			className: `runtime-widget climate-widget mode-${r} size-${e.size}`,
			children: [
				/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "אקלים בחדר" }), /* @__PURE__ */ (0, x.jsx)("h3", { children: w(i) })] }), /* @__PURE__ */ (0, x.jsx)("span", { children: r })] }),
				/* @__PURE__ */ (0, x.jsx)("div", {
					className: "climate-orbit",
					children: /* @__PURE__ */ (0, x.jsxs)("div", { children: [
						/* @__PURE__ */ (0, x.jsx)("small", { children: "עכשיו" }),
						/* @__PURE__ */ (0, x.jsxs)("strong", { children: [t.toFixed(1), "°"] }),
				...
				/* @__PURE__ */ (0, x.jsxs)("footer", { children: [
					...
					/* @__PURE__ */ (0, x.jsx)("span", { children: String(i.attributes.hvac_action ?? r) }),
					/* @__PURE__ */ (0, x.jsx)("button", {
						onClick: () => s(-.5),
						children: "−"
					})
	...
	if (e.widgetType === "camera.viewer" && i) return /* @__PURE__ */ (0, x.jsxs)("article", {
		className: `runtime-widget camera-widget size-${e.size}`,
		children: [/* @__PURE__ */ (0, x.jsx)("img", {
			src: `/api/camera_proxy/${i.entity_id}`,
			alt: w(i),
			loading: "lazy"
		}), /* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "מצלמה" }), /* @__PURE__ */ (0, x.jsx)("h3", { children: w(i) })] }), /* @__PURE__ */ (0, x.jsx)("span", { children: "LIVE" })] })]
	});
	if (e.widgetType === "media.player" && i) {
		let n = i.state === "playing";
		return /* @__PURE__ */ (0, x.jsxs)("article", {
			className: `runtime-widget media-widget ${n ? "is-active" : ""} size-${e.size}`,
			children: [
				/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "מדיה" }), /* @__PURE__ */ (0, x.jsx)("h3", { children: w(i) })] }), /* @__PURE__ */ (0, x.jsx)("span", { children: i.state })] }),
				/* @__PURE__ */ (0, x.jsxs)("div", {
					className: "media-title",
					children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: String(i.attributes.media_title ?? "אין תוכן פעיל") }), /* @__PURE__ */ (0, x.jsx)("small", { children: String(i.attributes.media_artist ?? i.attributes.app_name ?? "") })]
				}),
				/* @__PURE__ */ (0, x.jsxs)("footer", { children: [
					/* @__PURE__ */ (0, x.jsx)("button", {
						onClick: () => t.callService("media_player", "media_previous_track", {}, { entity_id: i.entity_id }),
						children: "‹"
					}),
					/* @__PURE__ */ (0, x.jsx)("button", {
						className: "media-main",
						onClick: () => t.callService("media_player", n ? "media_pause" : "media_play", {}, { entity_id: i.entity_id }),
						children: n ? "Ⅱ" : "▶"
					}),
					/* @__PURE__ */ (0, x.jsx)("button", {
						onClick: () => t.callService("media_player", "media_next_track", {}, { entity_id: i.entity_id }),
						children: "›"
					})
				] })
			]
	...
	return e.widgetType === "light.collection" ? /* @__PURE__ */ (0, x.jsxs)("article", {
		className: `runtime-widget collection-widget light-widget ${a ? "is-active" : ""} size-${e.size}`,
		children: [/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "תאורה" }), /* @__PURE__ */ (0, x.jsx)("h3", { children: a ? `${a} מוקדים פעילים` : "כל התאורה כבויה" })] }), /* @__PURE__ */ (0, x.jsx)("span", { children: r.length })] }), /* @__PURE__ */ (0, x.jsx)("div", {
			className: "entity-controls",
			children: r.slice(0, 12).map((e) => {
				let n = e.state === "on", r = Math.round(Number(e.attributes.brightness ?? 0) / 2.55), i = Number(e.attributes.supported_color_modes ? 1 : e.attributes.supported_features ?? 0) > 0;
				return /* @__PURE__ */ (0, x.jsxs)("div", {
					className: `light-row ${n ? "active" : ""}`,
					children: [/* @__PURE__ */ (0, x.jsxs)("button", {
						onClick: () => o(e),
						children: [/* @__PURE__ */ (0, x.jsx)("i", {}), /* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: w(e) }), /* @__PURE__ */ (0, x.jsx)("small", { children: n ? `${r || 100}%` : "כבוי" })] })]
					}), i && /* @__PURE__ */ (0, x.jsx)("input", {
						"aria-label": `עוצמת ${w(e)}`,
						type: "range",
						min: "1",
						max: "100",
						value: n ? r || 100 : 1,
						onChange: (n) => t.callService("light", "turn_on", { brightness_pct: Number(n.target.value) }, { entity_id: e.entity_id })
					})]
				}, e.entity_id);
			})
		})]
	}) : e.widgetType === "cover.control" && i ? /* @__PURE__ */ (0, x.jsxs)("article", {
		className: `runtime-widget cover-widget ${i.state === "closed" ? "" : "is-active"} size-${e.size}`,
		children: [
			/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "תריסים ווילונות" }), /* @__PURE__ */ (0, x.jsx)("h3", { children: w(i) })] }), /* @__PURE__ */ (0, x.jsxs)("span", { children: [String(i.attributes.current_position ?? (i.state === "open" ? 100 : 0)), "%"] })] }),
			/* @__PURE__ */ (0, x.jsx)("div", {
				className: "cover-position",
				children: /* @__PURE__ */ (0, x.jsx)("i", { style: { height: `${Number(i.attributes.current_position ?? 0)}%` } })
			}),
			/* @__PURE__ */ (0, x.jsxs)("footer", { children: [
				/* @__PURE__ */ (0, x.jsx)("button", {
					onClick: () => t.callService("cover", "open_cover", {}, { entity_id: i.entity_id }),
					children: "פתיחה"
				}),
				/* @__PURE__ */ (0, x.jsx)("button", {
					onClick: () => t.callService("cover", "stop_cover", {}, { entity_id: i.entity_id }),
					children: "עצירה"
				}),
				/* @__PURE__ */ (0, x.jsx)("button", {
					onClick: () => t.callService("cover", "close_cover", {}, { entity_id: i.entity_id }),
					children: "סגירה"
				})
			] })
		]
	}) : e.widgetType === "security.alarm" && i ? /* @__PURE__ */ (0, x.jsxs)("article", {
		className: `runtime-widget alarm-widget state-${i.state} size-${e.size}`,
		children: [
			/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "לוח בקרה" }), /* @__PURE__ */ (0, x.jsx)("h3", { children: w(i) })] }), /* @__PURE__ */ (0, x.jsx)("span", { children: i.state })] }),
			/* @__PURE__ */ (0, x.jsx)("div", {
				className: "alarm-state",
				children: /* @__PURE__ */ (0, x.jsx)("strong", { children: i.state === "disarmed" ? "המערכת מנוטרלת" : "המערכת דרוכה" })
			}),
			/* @__PURE__ */ (0, x.jsxs)("footer", { children: [
				/* @__PURE__ */ (0, x.jsx)("button", {
					onClick: () => t.callService("alarm_control_panel", "alarm_disarm", {}, { entity_id: i.entity_id }),
					children: "נטרול"
				}),
				/* @__PURE__ */ (0, x.jsx)("button", {
					onClick: () => t.callService("alarm_control_panel", "alarm_arm_home", {}, { entity_id: i.entity_id }),
					children: "מצב בית"
				}),
				/* @__PURE__ */ (0, x.jsx)("button", {
					onClick: () => t.callService("alarm_control_panel", "alarm_arm_away", {}, { entity_id: i.entity_id }),
					children: "יציאה"
				})
			] })
		]
	}) : e.widgetType.startsWith("sensor.") && i ? /* @__PURE__ */ (0, x.jsxs)("article", {
		className: `runtime-widget sensor-widget size-${e.size}`,
		children: [/* @__PURE__ */ (0, x.jsx)("header", { children: /* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: C[e.widgetType] ?? "חיישן" }), /* @__PURE__ */ (0, x.jsx)("h3", { children: w(i) })] }) }), /* @__PURE__ */ (0, x.jsxs)("strong", {
			className: "sensor-value",
			children: [i.state, /* @__PURE__ */ (0, x.jsx)("small", { children: String(i.attributes.unit_of_measurement ?? "") })]
		})]
	}) : /* @__PURE__ */ (0, x.jsxs)("article", {
		className: `runtime-widget collection-widget ${a ? "is-active" : ""} size-${e.size}`,
		children: [/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: C[e.widgetType] ?? e.widgetType }), /* @__PURE__ */ (0, x.jsx)("h3", { children: a ? `${a} פעילים` : "הכל שקט" })] }), /* @__PURE__ */ (0, x.jsx)("span", { children: r.length })] }), /* @__PURE__ */ (0, x.jsx)("div", {
			className: "entity-controls",
			children: r.slice(0, 8).map((e) => /* @__PURE__ */ (0, x.jsxs)("button", {
				className: ee.has(e.state) ? "" : "active",
				onClick: () => o(e),
				children: [/* @__PURE__ */ (0, x.jsx)("i", {}), /* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: w(e) }), /* @__PURE__ */ (0, x.jsx)("small", { children: e.state })] })]
			}, e.entity_id))
		})]
	});
}
//#endregion
//#region src/runtime/RuntimeApp.tsx
var ne = {
	overview: "סקירה",
	lighting: "תאורה",
	climate: "אקלים",
	...
	energy: "אנרגיה",
	cameras: "מצלמות"
}, T = (e) => e.startsWith("light.") || e.startsWith("switch.") || e.startsWith("cover.") ? "lighting" : e.startsWith("climate.") || e === "sensor.temperature" ? "climate" : e.startsWith("media.") ? "media" : e.startsWith("camera.") ? "cameras" : e.startsWith("security.") ? "security" : e === "sensor.power" || e === "sensor.energy" ? "energy" : "overview";
function re({ hass: e, narrow: t }) {
	let [n, r] = (0, b.useState)(), [i, a] = (0, b.useState)(), [o, s] = (0, b.useState)(1), [c, l] = (0, b.useState)(!1), [u, d] = (0, b.useState)(), [f, p] = (0, b.useState)(), [m, h] = (0, b.useState)(!0), [g, _] = (0, b.useState)(""), [v, y] = (0, b.useState)("overview");
	(0, b.useEffect)(() => {
		if (!e?.callWS) return;
		let t = !1;
		return h(!0), p(void 0), Promise.all([e.callWS({ type: "homeii/discovery/get" }), e.callWS({ type: "homeii/project/active" })]).then(async ([n, i]) => {
			if (t) return;
			let o = i.project ?? void 0;
			!o && e.user?.is_admin && (o = await e.callWS?.({
				type: "homeii/project/preview",
				project_id: "home",
				name: "הבית שלי",
				template: "area-first"
			})), r(n), a(o), s(i.revision), l(!!i.project), d((e) => e || n.areas[0]?.area_id);
		}).catch((e) => {
			t || p(e instanceof Error ? e.message : String(e));
		}).finally(() => {
			t || h(!1);
		}), () => {
			t = !0;
		...
		let t = async () => {
			try {
				let t = await e.callWS?.({ type: "homeii/discovery/get" });
				t && r(t);
			} catch {}
	...
	let S = u ? i?.areas[u] : void 0, C = n?.areas.find((e) => e.area_id === u), w = (0, b.useMemo)(() => new Set(S?.widgets.flatMap((e) => e.entityIds) ?? []), [S]), ee = (0, b.useMemo)(() => C?.entities.filter((e) => w.has(e.entity_id)).map((t) => e?.states[t.entity_id] ?? t) ?? [], [
		C,
		w,
		e?.states
	]), re = S?.categories?.length ? S.categories : ["overview", ...new Set((S?.widgets ?? []).map((e) => T(e.widgetType)))], ie = S?.widgets.filter((e) => v === "overview" || T(e.widgetType) === v) ?? [], ae = S?.titleMode === "custom" ? S.title : C?.name ?? S?.title;
	function oe(e) {
		_(e), window.setTimeout(() => _(""), 2200);
	}
	async function se() {
		if (!(!e?.callWS || !e.user?.is_admin)) {
			h(!0), p(void 0);
			try {
	...
	if (!e) return /* @__PURE__ */ (0, x.jsxs)("main", {
		className: "runtime-state",
		children: [/* @__PURE__ */ (0, x.jsx)("span", { className: "pulse" }), "מתחבר ל־Home Assistant…"]
	});
	if (m) return /* @__PURE__ */ (0, x.jsxs)("main", {
		className: "runtime-state",
		children: [/* @__PURE__ */ (0, x.jsx)("span", { className: "pulse" }), "סורק Areas וישויות…"]
	});
	if (f) return /* @__PURE__ */ (0, x.jsxs)("main", {
		className: "runtime-state runtime-error",
		children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: "החיבור ל־HOMEii נכשל" }), /* @__PURE__ */ (0, x.jsx)("code", { children: f })]
	});
	let ce = i?.theme?.tokens ?? {};
	return /* @__PURE__ */ (0, x.jsxs)("main", {
		className: `runtime-shell theme-${i?.theme?.preset ?? "granite"} ${t ? "is-narrow" : ""}`,
		dir: "rtl",
		style: {
			"--homeii-accent": String(ce.accent ?? "#d6a45d"),
			"--homeii-text": String(ce.text ?? "#f8f5ef"),
			"--homeii-surface": String(ce.surface ?? "#1b1918"),
			"--homeii-radius": `${Number(ce.radius ?? 24)}px`,
			"--homeii-blur": `${Number(ce.blur ?? 26)}px`,
			"--homeii-tile-opacity": String(ce.tileOpacity ?? .72)
		},
		children: [
			/* @__PURE__ */ (0, x.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: i?.brand?.name ?? "HOMEii" }), /* @__PURE__ */ (0, x.jsx)("span", { children: i?.brand?.tagline ?? "הבית שלך, ברור ונגיש" })] }),
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [e.user?.is_admin && !c && /* @__PURE__ */ (0, x.jsx)("button", {
							className: "publish-button",
							style: {
								minHeight: 42,
								paddingInline: 17,
								border: "1px solid #edc78a7a",
								borderRadius: 14,
								background: "linear-gradient(145deg,#d4a25e,#89623a)",
								color: "#17110b",
								fontWeight: 700,
								cursor: "pointer"
							},
							onClick: se,
							children: "צור ופרסם דשבורד"
						}), /* @__PURE__ */ (0, x.jsxs)("div", {
							className: "runtime-health",
							children: [
								/* @__PURE__ */ (0, x.jsx)("i", {}),
								c ? "פורסם" : "תצוגה מקדימה",
								" · ",
								n?.areas.length ?? 0,
								" אזורים · ",
								Object.values(n?.domains ?? {}).reduce((e, t) => e + t, 0),
								" ישויות"
							]
						})]
					})
			...
			/* @__PURE__ */ (0, x.jsx)("nav", {
				className: "area-nav",
				"aria-label": "חדרים ואזורים",
				children: Object.values(i?.areas ?? {}).filter((e) => !e.hidden).map((e) => {
					let t = n?.areas.find((t) => t.area_id === e.areaId);
					return /* @__PURE__ */ (0, x.jsxs)("button", {
						className: e.areaId === u ? "active" : "",
						onClick: () => {
							d(e.areaId), y("overview");
						},
						children: [/* @__PURE__ */ (0, x.jsx)("span", { children: e.titleMode === "custom" ? e.title : t?.name ?? e.title }), /* @__PURE__ */ (0, x.jsxs)("small", { children: [e.widgets.length, " רכיבים"] })]
					}, e.areaId);
				})
			}),
			/* @__PURE__ */ (0, x.jsxs)("section", {
				className: "runtime-content",
				children: [
					/* @__PURE__ */ (0, x.jsxs)("article", {
						className: "area-hero",
						style: C?.picture ? { backgroundImage: `linear-gradient(90deg, rgba(10,12,16,.86), rgba(10,12,16,.22)), url(${C.picture})` } : void 0,
						children: [
							/* @__PURE__ */ (0, x.jsxs)("span", { children: [i?.brand?.name ?? "HOMEii", " · AREA"] }),
							/* @__PURE__ */ (0, x.jsx)("h1", { children: ae ?? "לא נמצאו Areas" }),
							/* @__PURE__ */ (0, x.jsxs)("div", {
								className: "hero-status",
								children: [
									/* @__PURE__ */ (0, x.jsx)("b", { children: ee.filter((e) => ![
										"off",
										"idle",
										"closed",
										"unavailable",
									...
									/* @__PURE__ */ (0, x.jsx)("span", { children: "פעילים עכשיו" }),
									/* @__PURE__ */ (0, x.jsx)("i", {}),
									/* @__PURE__ */ (0, x.jsx)("b", { children: ee.length }),
									/* @__PURE__ */ (0, x.jsx)("span", { children: "רכיבים נבחרים" })
								]
							})
						]
					}),
					/* @__PURE__ */ (0, x.jsx)("nav", {
						...
						"aria-label": "קטגוריות בחדר",
						children: re.map((e) => /* @__PURE__ */ (0, x.jsx)("button", {
					...
					S && /* @__PURE__ */ (0, x.jsxs)("section", {
						...
						children: [ie.map((t) => /* @__PURE__ */ (0, x.jsx)(te, {
							widget: t,
							hass: e,
							onFeedback: oe
						}, t.id)), !ie.length && /* @__PURE__ */ (0, x.jsxs)("div", {
							className: "runtime-empty",
							children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: "הקטגוריה עדיין ריקה" }), /* @__PURE__ */ (0, x.jsx)("span", { children: "מנהל יכול להוסיף אליה Widgets דרך HOMEii Studio." })]
						})]
					})
				]
			}),
...
//#endregion
//#region src/runtime/runtime.css?inline
var ie = ":host{color:#f8f5f0;background:#151515;min-height:100%;font-family:Heebo,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;display:block}*{box-sizing:border-box}.runtime-shell{background:radial-gradient(circle at 75% 0,#4a392c 0,#0000 35%),linear-gradient(145deg,#171719,#25211e 60%,#101114);min-height:100vh;padding:clamp(16px,2vw,32px)}.runtime-header{align-items:center;gap:14px;max-width:1600px;margin:auto;display:flex}.runtime-header strong{letter-spacing:-1px;font-size:25px;display:block}.runtime-header span{color:#bdb6ac;font-size:13px;display:block}.brand-mark{color:#18120d;background:linear-gradient(145deg,#e0b36e,#8c6438);border-radius:16px;place-items:center;width:48px;height:48px;font-size:24px;font-weight:900;display:grid;box-shadow:inset 0 1px #fff5,0 14px 38px #0005}.runtime-health{color:#d7d0c7;background:#ffffff0d;border:1px solid #ffffff1c;border-radius:999px;margin-inline-start:auto;padding:10px 15px;font-size:13px}.runtime-health i,.pulse{background:#79daa6;border-radius:50%;width:8px;height:8px;margin-inline-end:8px;display:inline-block;box-shadow:0 0 14px #79daa6}.area-nav{scrollbar-width:none;gap:9px;max-width:1600px;margin:26px auto 14px;padding:2px;display:flex;overflow:auto}.area-nav button{text-align:right;color:#d8d3cc;cursor:pointer;background:#ffffff0a;border:1px solid #ffffff14;border-radius:17px;flex:none;min-width:140px;padding:13px 17px}.area-nav button.active{color:#fff;background:linear-gradient(145deg,#a47844aa,#684a2ddd);border-color:#e2b77888;box-shadow:inset 0 1px #ffffff38}.area-nav span,.area-nav small{display:block}.area-nav small{opacity:.65;margin-top:3px}.runtime-content{max-width:1600px;margin:auto}.area-hero{background:linear-gradient(140deg,#332a23,#171719) 50%/cover;border:1px solid #ffffff1f;border-radius:32px;flex-direction:column;justify-content:flex-end;min-height:clamp(230px,34vh,410px);padding:clamp(24px,4vw,58px);display:flex;overflow:hidden;box-shadow:inset 0 1px #ffffff28,0 30px 90px #0005}.area-hero>span{color:#d7b77f;font-size:13px}.area-hero h1{letter-spacing:-2px;margin:8px 0 20px;font-size:clamp(38px,6vw,78px);line-height:1}.domain-chips{flex-wrap:wrap;gap:8px;display:flex}.domain-chips span{-webkit-backdrop-filter:blur(16px);backdrop-filter:blur(16px);background:#0c0c0e7a;border:1px solid #ffffff24;border-radius:999px;padding:8px 12px;font-size:13px}.runtime-grid{grid-template-columns:minmax(0,.8fr) minmax(0,1.2fr);gap:14px;margin-top:14px;display:grid}.preview-card{-webkit-backdrop-filter:blur(22px);backdrop-filter:blur(22px);background:linear-gradient(145deg,#ffffff12,#ffffff07);border:1px solid #ffffff18;border-radius:26px;min-width:0;padding:22px;box-shadow:inset 0 1px #ffffff17}.preview-card>header{justify-content:space-between;align-items:center;margin-bottom:16px;display:flex}.preview-card h2{margin:3px 0 0;font-size:22px}.preview-card header span,.widget-row small,.entity-list small{color:#aaa39a;font-size:12px}.preview-card header b{color:#f1c98f;background:#d09a5540;border-radius:14px;place-items:center;width:42px;height:42px;display:grid}.widget-list,.entity-list{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;display:grid}.widget-row,.entity-list button{min-width:0;color:inherit;text-align:right;background:#0e0f12a8;border:1px solid #ffffff12;border-radius:16px;align-items:center;gap:11px;padding:13px;display:flex}.widget-row i{background:#d09a55;border-radius:4px;width:10px;height:10px;box-shadow:0 0 16px #d09a55}.widget-row strong,.widget-row small,.entity-list strong,.entity-list small{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.entity-list button{cursor:pointer;justify-content:space-between}.entity-list button>div{min-width:0}.entity-list button>span{text-overflow:ellipsis;color:#8ce1b3;background:#7fd9aa20;border-radius:10px;max-width:38%;padding:6px 9px;overflow:hidden}.entity-list button>span.unavailable{color:#ef9595;background:#e8777720}.runtime-state{text-align:center;color:#eee;background:#151515;place-content:center;gap:12px;min-height:100vh;font:18px Heebo,sans-serif;display:grid}.runtime-state .pulse{margin:auto;animation:1.4s infinite pulse}.runtime-error code{white-space:normal;color:#efaaaa;max-width:700px}@keyframes pulse{50%{opacity:.6;transform:scale(1.45)}}.is-narrow{padding:12px}.is-narrow .runtime-health{display:none}.is-narrow .area-nav{margin-top:18px}.is-narrow .area-nav button{min-width:118px}.is-narrow .area-hero{border-radius:24px;min-height:260px;padding:24px}.is-narrow .runtime-grid,.is-narrow .widget-list,.is-narrow .entity-list{grid-template-columns:1fr}@media (max-width:620px){.runtime-grid,.widget-list,.entity-list{grid-template-columns:1fr}.runtime-header span{font-size:11px}.preview-card{border-radius:22px;padding:17px}}", ae = ".product-widgets{grid-template-columns:repeat(12,minmax(0,1fr));gap:12px;margin-top:14px;display:grid}.runtime-widget{-webkit-backdrop-filter:blur(24px);backdrop-filter:blur(24px);background:linear-gradient(145deg,#ffffff12,#ffffff07);border:1px solid #ffffff18;border-radius:26px;grid-column:span 4;min-width:0;min-height:210px;padding:20px;overflow:hidden;box-shadow:inset 0 1px #ffffff1c,0 24px 60px #0003}.runtime-widget.size-expanded{grid-column:span 6}.runtime-widget.size-compact{grid-column:span 3;min-height:150px}.runtime-widget header{justify-content:space-between;align-items:flex-start;display:flex}.runtime-widget header small,.runtime-widget header h3{margin:0;display:block}.runtime-widget header small{color:#a9a29a}.runtime-widget header h3{margin-top:4px;font-size:21px}.runtime-widget header>span{color:#bbb;background:#ffffff0e;border-radius:10px;padding:6px 9px;font-size:12px}.collection-widget.is-active{background:radial-gradient(circle at 100% 0,#dba45a30,#0000 42%),linear-gradient(145deg,#ffffff16,#ffffff08);border-color:#e2b36c55}.entity-controls{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px;margin-top:17px;display:grid}.entity-controls button{color:#aaa;text-align:right;cursor:pointer;background:#0b0c0f99;border:1px solid #ffffff10;border-radius:14px;align-items:center;gap:9px;min-width:0;padding:11px;display:flex}.entity-controls button i{background:#5d5f63;border-radius:50%;flex:none;width:9px;height:9px}.entity-controls button.active{color:#fff;background:#d5a15720;border-color:#e0ad6355}.entity-controls button.active i{background:#f0bd6d;box-shadow:0 0 14px #e8aa52}.entity-controls strong,.entity-controls small{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.entity-controls span{min-width:0}.entity-controls small{opacity:.58}.climate-widget{background:radial-gradient(circle,#75aaff20,#0000 42%),linear-gradient(145deg,#202b3b,#16191e)}.climate-widget.mode-heat{background:radial-gradient(circle,#ff8d492b,#0000 42%),linear-gradient(145deg,#35251f,#18191c)}.climate-orbit{border:12px solid #6ea6f4;border-inline-start-color:#ffffff2c;border-radius:50%;place-items:center;width:150px;height:150px;margin:8px auto;display:grid;box-shadow:0 0 35px #6ea6f426,inset 0 0 28px #0007}.mode-heat .climate-orbit{border-color:#f09a59;border-inline-start-color:#ffffff2c}.climate-orbit div{text-align:center}.climate-orbit small,.climate-orbit strong,.climate-orbit b{display:block}.climate-orbit strong{font-size:38px}.climate-orbit b{color:#9dbff2;font-size:11px}.runtime-widget footer{justify-content:space-between;align-items:center;display:flex}.runtime-widget footer button{color:#fff;cursor:pointer;background:#ffffff0c;border:1px solid #ffffff1b;border-radius:50%;width:42px;height:42px;font-size:24px}.camera-widget{background:#08090b;padding:0;position:relative}.camera-widget img{object-fit:cover;width:100%;height:100%;min-height:250px}.camera-widget header{-webkit-backdrop-filter:blur(15px);backdrop-filter:blur(15px);background:#1119;border:1px solid #fff2;border-radius:17px;padding:14px;position:absolute;inset:auto 14px 14px}.media-title{margin:35px 0}.media-title strong,.media-title small{display:block}.media-title strong{font-size:24px}.media-title small{color:#a8a19a}.media-widget footer{justify-content:center;gap:14px}.media-widget footer .media-main{color:#17110b;background:#d5a45e;width:54px;height:54px}.sensor-value{margin-top:35px;font-size:46px;display:block}.sensor-value small{color:#aaa;margin-inline-start:5px;font-size:16px}.runtime-feedback{z-index:20;color:#a5ebc8;-webkit-backdrop-filter:blur(18px);backdrop-filter:blur(18px);background:#13251ddd;border:1px solid #8de1b655;border-radius:14px;padding:11px 17px;position:fixed;inset:auto 50% 24px auto;transform:translate(50%);box-shadow:0 20px 50px #0007}@media (max-width:900px){.runtime-widget,.runtime-widget.size-expanded{grid-column:span 6}.runtime-widget.size-compact{grid-column:span 4}}@media (max-width:620px){.product-widgets{display:block}.runtime-widget{min-height:auto;margin-bottom:10px}.entity-controls{grid-template-columns:1fr}.camera-widget img{min-height:210px}}", oe = ".runtime-shell{--homeii-accent:#d6a45d;--homeii-text:#f8f5ef;--homeii-surface:#1b1918;--homeii-radius:24px;--homeii-blur:26px;--homeii-tile-opacity:.72;color:var(--homeii-text);background:radial-gradient(circle at 75% 0,color-mix(in srgb,var(--homeii-accent) 25%,transparent),transparent 35%),linear-gradient(145deg,#111214,color-mix(in srgb,var(--homeii-surface) 88%,#08090b) 60%,#090a0c);grid-template:72px auto 1fr/220px minmax(0,1fr);column-gap:16px;display:grid}.runtime-header{grid-area:1/2;width:100%}.brand-mark{background:linear-gradient(145deg,color-mix(in srgb,var(--homeii-accent) 88%,white),color-mix(in srgb,var(--homeii-accent) 72%,black));overflow:hidden}.brand-mark img{object-fit:contain;width:76%;height:76%}.area-nav{border-radius:calc(var(--homeii-radius) * 1.2);background:color-mix(in srgb,var(--homeii-surface) 82%,transparent);width:100%;-webkit-backdrop-filter:blur(var(--homeii-blur));backdrop-filter:blur(var(--homeii-blur));border:1px solid #ffffff1a;flex-direction:column;grid-area:1/1/4;margin:0;padding:16px 10px;overflow:auto}.area-nav:before{content:\"חדרים\";color:#ffffff75;padding:8px 12px;font-size:12px;font-weight:700}.area-nav button{width:100%;min-width:0}.area-nav button.active{background:linear-gradient(145deg,color-mix(in srgb,var(--homeii-accent) 42%,var(--homeii-surface)),var(--homeii-surface));border-color:color-mix(in srgb,var(--homeii-accent) 60%,transparent)}.runtime-content{grid-area:2/2/4;width:100%}.area-hero{border-color:color-mix(in srgb,var(--homeii-accent) 22%,#ffffff1f);border-radius:calc(var(--homeii-radius) * 1.3);background-color:var(--homeii-surface)}.area-hero>span{color:var(--homeii-accent)}.hero-status{background:color-mix(in srgb,var(--homeii-surface) calc(var(--homeii-tile-opacity) * 100%),transparent);max-width:max-content;-webkit-backdrop-filter:blur(var(--homeii-blur));backdrop-filter:blur(var(--homeii-blur));border:1px solid #ffffff24;border-radius:999px;align-items:center;gap:9px;padding:10px 14px;font-size:13px;display:flex}.hero-status b{color:var(--homeii-accent);font-size:18px}.hero-status i{background:#fff2;width:1px;height:24px;margin:0 5px}.category-nav{scrollbar-width:none;gap:7px;margin:12px 0;display:flex;overflow:auto}.category-nav button{color:#bbb;background:color-mix(in srgb,var(--homeii-surface) 76%,transparent);cursor:pointer;border:1px solid #ffffff17;border-radius:15px;min-width:100px;min-height:46px;padding:0 16px}.category-nav button.active{color:var(--homeii-text);border-color:color-mix(in srgb,var(--homeii-accent) 58%,transparent);background:color-mix(in srgb,var(--homeii-accent) 24%,var(--homeii-surface))}.runtime-empty{border-radius:var(--homeii-radius);text-align:center;color:#aaa;border:1px dashed #ffffff28;grid-column:1/-1;place-content:center;min-height:190px;padding:30px;display:grid}.runtime-empty strong{color:var(--homeii-text);font-size:20px}.runtime-empty span{margin-top:6px}@media (max-width:900px){.runtime-shell{padding-bottom:92px;display:block}.runtime-header{width:auto}.area-nav{z-index:20;border-radius:22px;flex-direction:row;width:auto;padding:7px;position:fixed;inset:auto 10px 10px;box-shadow:0 18px 60px #0009}.area-nav:before,.area-nav small{display:none}.area-nav button{text-align:center;min-width:82px;padding:11px 10px}.runtime-content{width:auto}.area-hero{min-height:300px}.hero-status{font-size:12px}.runtime-actions .publish-button{display:none}}", se = ".light-row{background:#ffffff05;border-radius:14px;grid-template-columns:1fr;gap:3px;padding:5px;display:grid}.light-row.active{background:color-mix(in srgb,var(--homeii-accent) 14%,transparent)}.light-row>button{width:100%}.light-row input{width:calc(100% - 16px);height:4px;accent-color:var(--homeii-accent);margin:2px 8px 7px}.cover-widget{background:linear-gradient(145deg,color-mix(in srgb,#7ebcff 13%,var(--homeii-surface)),var(--homeii-surface))}.cover-position{background:repeating-linear-gradient(0deg,#ffffff0a 0 12px,#0000 12px 17px);border:1px solid #ffffff20;border-radius:18px;height:130px;margin:14px;position:relative;overflow:hidden}.cover-position i{background:linear-gradient(#7ebcff50,#7ebcff12);transition:height .5s;position:absolute;inset:auto 0 0}.cover-widget footer,.alarm-widget footer{grid-template-columns:repeat(3,1fr);gap:7px;display:grid}.cover-widget footer button,.alarm-widget footer button{min-height:42px;color:inherit;background:#ffffff09;border:1px solid #ffffff1a;border-radius:13px}.alarm-widget{background:linear-gradient(145deg,color-mix(in srgb,#ff7a72 12%,var(--homeii-surface)),var(--homeii-surface))}.alarm-widget.state-disarmed{background:linear-gradient(145deg,color-mix(in srgb,#69d7a0 10%,var(--homeii-surface)),var(--homeii-surface))}.alarm-state{text-align:center;place-content:center;min-height:110px;display:grid}.alarm-state strong{font-size:22px}.ha-card-widget{background:0 0;border:0;padding:0;overflow:visible}.ha-card-widget>div{width:100%}.ha-card-widget ha-card{border-radius:var(--homeii-radius)!important}";
//#endregion
//#region src/studio/StudioApp.tsx
async function ce(e, t) {
	let n = await fetch(`./api/platform/${e}`, {
		cache: "no-store",
...
var le = {
	...
	"legacy.lovelace-card": {
		label: "כרטיס Home Assistant",
		glyph: "HA",
		domains: [],
		category: "overview",
		size: "regular"
...
function de({ hass: e, value: t, domains: n, entities: r, onChange: i }) {
	let a = (0, b.useRef)(null);
	return (0, b.useEffect)(() => {
		if (!e || !a.current) return;
		let r = document.createElement("ha-entity-picker");
		r.hass = e, r.value = t, r.includeDomains = n, r.allowCustomEntity = !1;
		let o = (e) => i(String(e.detail?.value ?? ""));
		return r.addEventListener("value-changed", o), a.current.replaceChildren(r), () => r.removeEventListener("value-changed", o);
	}, [
		e,
		t,
		n.join("|")
		...
		children: [/* @__PURE__ */ (0, x.jsx)("option", {
			value: "",
			children: "בחר ישות"
		}), r.filter((e) => !n.length || n.includes(e.domain)).map((e) => /* @__PURE__ */ (0, x.jsxs)("option", {
			value: e.entity_id,
			children: [
				e.name,
				" · ",
...
function fe({ hass: e, widget: t, meta: n, entities: r, pickerValue: i, setPickerValue: a, updateWidget: o, duplicateWidget: s, removeWidget: c }) {
	let l = t.settings?.source ?? {}, u = (e) => o(t.id, (t) => ({
		...t,
		settings: {
			...t.settings,
			generated: !1,
	...
	return /* @__PURE__ */ (0, x.jsxs)("aside", {
		className: "floating-widget-inspector",
		children: [
			/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "WIDGET INSPECTOR" }), /* @__PURE__ */ (0, x.jsx)("strong", { children: n?.label ?? t.widgetType })] }), /* @__PURE__ */ (0, x.jsx)("button", {
				onClick: c,
				children: "×"
			})] }),
			/* @__PURE__ */ (0, x.jsxs)("label", { children: ["גודל", /* @__PURE__ */ (0, x.jsxs)("select", {
				value: t.size,
				onChange: (e) => o(t.id, (t) => ({
					...t,
					size: e.target.value
			...
			t.widgetType === "legacy.lovelace-card" && /* @__PURE__ */ (0, x.jsxs)("section", {
				className: "visual-card-builder",
				children: [
					/* @__PURE__ */ (0, x.jsx)("strong", { children: "כרטיס Home Assistant" }),
					/* @__PURE__ */ (0, x.jsxs)("label", { children: ["סוג כרטיס", /* @__PURE__ */ (0, x.jsxs)("select", {
						value: String(l.type ?? "tile"),
						...
						children: [
							...
							/* @__PURE__ */ (0, x.jsx)("option", {
								value: "picture-entity",
								children: "Picture Entity"
							}),
							/* @__PURE__ */ (0, x.jsx)("option", {
								value: "gauge",
								children: "Gauge"
					...
					/* @__PURE__ */ (0, x.jsxs)("label", { children: ["כותרת", /* @__PURE__ */ (0, x.jsx)("input", {
						value: String(l.name ?? ""),
			...
			/* @__PURE__ */ (0, x.jsxs)("section", {
				className: "entity-bindings",
				children: [
					/* @__PURE__ */ (0, x.jsx)("strong", { children: "ישויות משויכות" }),
					t.entityIds.map((e) => /* @__PURE__ */ (0, x.jsxs)("div", {
						className: "entity-binding",
						children: [/* @__PURE__ */ (0, x.jsxs)("span", { children: [/* @__PURE__ */ (0, x.jsx)("b", { children: r.find((t) => t.entity_id === e)?.name ?? e }), /* @__PURE__ */ (0, x.jsx)("small", { children: e })] }), /* @__PURE__ */ (0, x.jsx)("button", {
							onClick: () => {
								let n = t.entityIds.filter((t) => t !== e);
								o(t.id, (e) => ({
									...e,
									entityIds: n,
									settings: e.widgetType === "legacy.lovelace-card" ? {
										...e.settings,
										source: {
											...e.settings?.source ?? {},
											entity: n[0] ?? "",
					...
					/* @__PURE__ */ (0, x.jsx)(de, {
						...
						onChange: (e) => {
							if (!e) return;
							let n = [.../* @__PURE__ */ new Set([...t.entityIds, e])];
							o(t.id, (t) => ({
								...t,
								entityIds: n,
								settings: t.widgetType === "legacy.lovelace-card" ? {
									...t.settings,
									source: {
										...t.settings?.source ?? {},
										entity: e,
...
function pe({ hass: e } = {}) {
	...
	async function ee(t, n) {
		...
		let r = n?.body ? JSON.parse(String(n.body)) : {};
		return t === "generate" ? e.callWS({
			type: "homeii/project/generate",
			...r
		}) : e.callWS({
			...
			try {
				let e = await ee("generate", {
					...
					body: JSON.stringify({
						...
						name: a?.name ?? "הבית שלי",
						template: a?.template ?? "homeii-signature",
						revision: t.revision
					})
				});
				n({
					...t,
					revision: e.revision,
					active_project_id: e.project.id,
					project: e.project
				}), o(e.project), c(Object.keys(e.project.areas)[0] || ""), u("Project נוצר ופורסם");
			} catch (e) {
				u(`היצירה נכשלה: ${e.message}`);
			} finally {
				f(!1);
			}
		}
		...
		if (!(!a || !t)) {
			...
			try {
				...
				n({
					...
					revision: e.revision,
					project: a
				}), u("השינויים פורסמו לכל המכשירים");
			} catch (e) {
				u(`השמירה נכשלה: ${e.message}`);
			} finally {
				f(!1);
			}
		}
	...
	let be = {
		...
		"--preview-radius": `${Number(a.theme.tokens.radius ?? 24)}px`,
		"--preview-blur": `${Number(a.theme.tokens.blur ?? 26)}px`,
		...
		children: [
			/* @__PURE__ */ (0, x.jsxs)("header", {
				...
				children: [
					/* @__PURE__ */ (0, x.jsx)("div", {
						className: "studio-logo",
						children: a.brand.logo ? /* @__PURE__ */ (0, x.jsx)("img", {
							src: a.brand.logo,
							alt: ""
						}) : "H"
					}),
					/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("small", { children: "HOMEii DESIGN STUDIO" }), /* @__PURE__ */ (0, x.jsx)("strong", { children: a.name })] }),
					/* @__PURE__ */ (0, x.jsxs)("div", {
			...
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [
					/* @__PURE__ */ (0, x.jsx)("h2", { children: "Areas · תוכן" }),
					Object.values(a.areas).map((e) => /* @__PURE__ */ (0, x.jsxs)("button", {
						className: s === e.areaId ? "active" : "",
						onClick: () => {
							c(e.areaId), m("");
						},
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsxs)("section", { children: [
						...
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							"עיגול פינות · ",
							Number(a.theme.tokens.radius ?? 24),
							"px",
							/* @__PURE__ */ (0, x.jsx)("input", {
								type: "range",
								min: "12",
						...
						/* @__PURE__ */ (0, x.jsxs)("label", { children: [
							"שקיפות אריחים · ",
							Math.round(Number(a.theme.tokens.tileOpacity ?? .72) * 100),
							"%",
							/* @__PURE__ */ (0, x.jsx)("input", {
								type: "range",
								min: "35",
					...
					A && /* @__PURE__ */ (0, x.jsxs)("section", { children: [
						/* @__PURE__ */ (0, x.jsx)("small", {
							className: "eyebrow",
...
var O = ":host{color:#f8f5ef;background:#121315;min-height:100%;font-family:Heebo,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;display:block}*{box-sizing:border-box}button,input,select{font:inherit}.studio-shell{background:radial-gradient(circle at 80% 0,#49372466,#0000 32%),#121315;grid-template:76px 1fr/230px minmax(0,1fr) 290px;min-height:100vh;display:grid}.studio-topbar{-webkit-backdrop-filter:blur(22px);backdrop-filter:blur(22px);background:#18191cdd;border-bottom:1px solid #ffffff16;grid-column:1/-1;align-items:center;gap:12px;padding:12px 20px;display:flex}.studio-logo{color:#18110a;background:linear-gradient(145deg,#e2b46d,#805a34);border-radius:15px;place-items:center;width:46px;height:46px;font-size:23px;font-weight:900;display:grid;box-shadow:inset 0 1px #fff7,0 12px 30px #0005}.studio-topbar small,.studio-topbar strong{display:block}.studio-topbar small{color:#a9a39b;letter-spacing:1px;font-size:10px}.studio-status{color:#bcb6ae;margin-inline-start:auto;font-size:13px}.studio-status i{background:#79dca8;border-radius:50%;width:8px;height:8px;margin-inline-end:7px;display:inline-block;box-shadow:0 0 12px #79dca8}.studio-topbar a,.studio-topbar button,.studio-empty button{color:#eee;cursor:pointer;background:#ffffff0b;border:1px solid #ffffff1c;border-radius:14px;min-height:42px;padding:0 16px;text-decoration:none}.studio-topbar button,.studio-empty button{color:#17110c;background:linear-gradient(145deg,#d5a45e,#8a633b);border-color:#e5bd7b88;font-weight:750}.studio-sidebar,.studio-inspector{background:#17181bd9;border-inline-end:1px solid #ffffff12;padding:18px}.studio-inspector{border-inline-start:1px solid #ffffff12;border-inline-end:0}.studio-sidebar h2,.studio-inspector h2{color:#aaa39b;font-size:15px}.studio-sidebar button{color:#d6d1c9;text-align:right;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:14px;width:100%;margin-bottom:7px;padding:12px;display:block}.studio-sidebar button.active{color:#fff;background:#d6a45d20;border-color:#d6a45d55}.studio-sidebar span,.studio-sidebar small{display:block}.studio-sidebar small{opacity:.55}.studio-canvas{min-width:0;padding:18px;overflow:auto}.studio-hero{background:linear-gradient(145deg,#342a21,#18191c) 50%/cover;border:1px solid #ffffff1d;border-radius:28px;flex-direction:column;justify-content:flex-end;min-height:250px;padding:34px;display:flex;box-shadow:inset 0 1px #fff3}.studio-hero small{color:#d8af72}.studio-hero h1{margin:5px 0;font-size:48px}.studio-widgets{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-top:12px;display:grid}.studio-widgets article{background:linear-gradient(145deg,#ffffff0d,#ffffff06);border:1px solid #ffffff15;border-radius:18px;grid-template-columns:46px minmax(0,1fr) auto auto;align-items:center;gap:11px;padding:15px;display:grid}.widget-icon{color:#e7bd7d;background:#d6a45d22;border-radius:15px;place-items:center;width:46px;height:46px;font-weight:800;display:grid}.studio-widgets strong,.studio-widgets small{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.studio-widgets small{color:#99938b}.studio-widgets select,.studio-widgets button,.studio-inspector input,.studio-inspector select{color:#ddd;background:#0c0d10;border:1px solid #ffffff18;border-radius:11px;min-height:38px;padding:7px 10px}.studio-widgets button{cursor:pointer}.studio-inspector label{color:#aaa49c;margin:18px 0;font-size:12px;display:block}.studio-inspector label input,.studio-inspector label select{width:100%;margin-top:7px;display:block}.studio-metrics{grid-template-columns:1fr 1fr;gap:8px;display:grid}.studio-metrics span{color:#aaa;background:#ffffff09;border-radius:14px;padding:13px}.studio-metrics b{color:#fff;font-size:22px;display:block}.studio-empty{text-align:center;background:radial-gradient(circle at 50% 20%,#664a2d88,#0000 32%),#121315;place-content:center;justify-items:center;min-height:100vh;padding:24px;display:grid}.studio-empty h1{margin:18px 0 6px;font-size:clamp(34px,6vw,64px)}.studio-empty p{color:#aaa49b;max-width:600px}.studio-empty button{margin:20px 0 10px}@media (max-width:900px){.studio-shell{grid-template:70px auto 1fr/1fr}.studio-topbar{grid-column:1}.studio-status{display:none}.studio-sidebar{border:0;border-bottom:1px solid #ffffff12;display:flex;overflow:auto}.studio-sidebar h2{display:none}.studio-sidebar button{min-width:130px;margin:0 6px}.studio-canvas{grid-row:3}.studio-inspector{border:1px solid #ffffff1c;border-radius:22px;max-height:42vh;position:fixed;inset:auto 10px 10px;overflow:auto;box-shadow:0 20px 70px #000b}.studio-widgets{grid-template-columns:1fr}.studio-widgets article{grid-template-columns:42px minmax(0,1fr)}.studio-widgets select,.studio-widgets button{grid-column:auto}.studio-topbar a{display:none}}", k = ".studio-logo{overflow:hidden}.studio-logo img{object-fit:contain;width:76%;height:76%}.studio-topbar button.secondary{color:#ddd;background:#ffffff0b;border-color:#ffffff1c;font-weight:500}.studio-inspector{overflow:auto}.studio-inspector section{border-bottom:1px solid #ffffff12;margin-bottom:18px;padding:4px 0 18px}.studio-hero{min-height:290px;color:var(--preview-text);border-color:color-mix(in srgb,var(--preview-accent) 24%,transparent);border-radius:var(--preview-radius);background-color:var(--preview-surface)}.studio-hero small,.eyebrow{color:var(--preview-accent)}.studio-hero p{opacity:.72;margin:0 0 18px}.studio-categories{flex-wrap:wrap;gap:7px;display:flex}.studio-categories span{background:color-mix(in srgb,var(--preview-surface) calc(var(--preview-opacity) * 100%),transparent);-webkit-backdrop-filter:blur(var(--preview-blur));backdrop-filter:blur(var(--preview-blur));border:1px solid #ffffff20;border-radius:999px;padding:7px 11px;font-size:12px}.studio-widgets article{color:var(--preview-text);border-radius:calc(var(--preview-radius) * .72);border-color:color-mix(in srgb,var(--preview-accent) 14%,#ffffff15);background:color-mix(in srgb,var(--preview-surface) calc(var(--preview-opacity) * 100%),transparent);-webkit-backdrop-filter:blur(var(--preview-blur));backdrop-filter:blur(var(--preview-blur))}.studio-inspector input[type=range]{accent-color:var(--preview-accent);padding:0}.studio-inspector input[type=color]{height:42px;padding:3px}.eyebrow{letter-spacing:.14em;font-size:9px}.color-pair{grid-template-columns:repeat(3,1fr);gap:7px;display:grid}.toggle-row{align-items:center;gap:8px;display:flex!important}.toggle-row input{height:20px;accent-color:var(--preview-accent);width:20px!important;margin:0!important}.category-picker{grid-template-columns:1fr 1fr;gap:6px;display:grid}.category-picker button{color:#bbb;cursor:pointer;background:#ffffff08;border:1px solid #ffffff16;border-radius:11px;min-height:38px}.category-picker button.active{color:var(--preview-text);background:color-mix(in srgb,var(--preview-accent) 22%,transparent);border-color:color-mix(in srgb,var(--preview-accent) 55%,transparent)}", me = ".history-actions{gap:5px;display:flex}.history-actions button{min-width:40px;padding:0;font-size:20px}.library-divider{background:#ffffff14;height:1px;margin:16px 0}.library-search{color:#eee;background:#0c0d10;border:1px solid #ffffff18;border-radius:12px;width:100%;min-height:40px;margin-bottom:8px;padding:8px 10px}.visual-library{gap:6px;display:grid}.visual-library button{grid-template-columns:34px minmax(0,1fr) 22px;align-items:center;gap:8px;min-height:48px!important;display:grid!important}.visual-library i{background:color-mix(in srgb,var(--preview-accent) 18%,transparent);width:32px;height:32px;color:var(--preview-accent);border-radius:10px;place-items:center;font-style:normal;font-weight:800;display:grid}.visual-library b{font-size:18px}.studio-widgets article{cursor:pointer}.studio-widgets article.selected{outline:2px solid var(--preview-accent);outline-offset:2px}.drag-handle{color:#ffffff62;cursor:grab;letter-spacing:-3px}.floating-widget-inspector{z-index:30;border:1px solid color-mix(in srgb,var(--preview-accent) 35%,#ffffff18);-webkit-backdrop-filter:blur(28px);backdrop-filter:blur(28px);background:#17181bf2;border-radius:22px;width:340px;max-height:calc(100vh - 110px);padding:16px;position:fixed;inset:86px 306px auto auto;overflow:auto;box-shadow:0 24px 80px #000b}.floating-widget-inspector>header{justify-content:space-between;align-items:center;margin-bottom:12px;display:flex}.floating-widget-inspector header small,.floating-widget-inspector header strong{display:block}.floating-widget-inspector header small{color:var(--preview-accent);letter-spacing:.12em;font-size:9px}.floating-widget-inspector header strong{font-size:18px}.floating-widget-inspector button,.floating-widget-inspector input,.floating-widget-inspector select{color:#eee;background:#0c0d10;border:1px solid #ffffff18;border-radius:11px;min-height:38px;padding:7px 10px}.floating-widget-inspector>header button{width:38px;padding:0}.floating-widget-inspector label{color:#aaa;gap:6px;margin:12px 0;font-size:12px;display:grid}.visual-card-builder,.entity-bindings{border-top:1px solid #ffffff14;gap:7px;margin:14px 0;padding-top:14px;display:grid}.entity-binding{background:#ffffff08;border-radius:12px;grid-template-columns:minmax(0,1fr) 34px;align-items:center;gap:6px;padding:8px;display:grid}.entity-binding span,.entity-binding b,.entity-binding small{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.entity-binding small{color:#888;text-align:left;direction:ltr;font-size:9px}.entity-binding button{width:32px;min-height:32px;padding:0}.ha-picker{background:#fff;border-radius:12px;min-height:54px;padding:4px}.floating-widget-inspector footer{grid-template-columns:1fr 1fr;gap:7px;margin-top:14px;display:grid}.floating-widget-inspector .danger{color:#ffaaa6;background:#ff6e6712;border-color:#ff6e6755}@media (max-width:1100px){.floating-widget-inspector{width:min(440px,100% - 20px);max-height:55vh;inset:auto 10px 10px}.studio-topbar .history-actions{display:none}}@media (max-width:700px){.floating-widget-inspector{bottom:86px}.studio-sidebar{max-height:180px}.visual-library{grid-template-columns:repeat(2,minmax(150px,1fr))}}", A = class extends HTMLElement {
	...
	constructor() {
		...
		t.textContent = `${ie}\n${ae}\n${se}\n${oe}`, e.append(t, n), this.root = (0, y.createRoot)(n);
	}
	set hass(e) {
	...
	connectedCallback() {
		this.upgradeProperty("hass"), this.upgradeProperty("narrow"), this.renderPanel();
	}
	...
	renderPanel() {
		this.root.render(/* @__PURE__ */ (0, x.jsx)(re, {
			hass: this._hass,
			narrow: this._narrow
		}));
	}
